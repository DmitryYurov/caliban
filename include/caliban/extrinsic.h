 ...
 * @param image_points The 2D points in the image coordinate system. The map key corresponds to the index of the target point.
 * @param Bs The base-to-flange SE3 transformations
 * @param X Input/Output parameter for the base-to-target SE3 transformation (eye in hand) or the base-to camera SE3 transformation (eye to hand)
 * @param Z Input/Output parameter for the flange-to-camera SE3 transformation (eye in hand) or to the target (eye to hand)
